...
void c_client_connection_handlers_overseer::c_client_connection_handler::set_next_aviable(
	c_client_connection_handler *next_aviable_exemplum)
{
	next_aviable = next_aviable_exemplum;
}

c_client_connection_handlers_overseer::c_client_connection_handler *
	c_client_connection_handlers_overseer::c_client_connection_handler::get_next_aviable(void) const
{
	return (next_aviable);
}
...
void c_client_connection_handlers_overseer::c_client_connection_handler::set_memory_shared_whit_the_ring(
	uint8_t *memory_shared_whit_the_ring_exemplum)
{
	memory_shared_whit_the_ring = memory_shared_whit_the_ring_exemplum;
}
